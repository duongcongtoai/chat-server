...
func (c *chatServiceClient) SendMessage(ctx context.Context, in *SendMessageRequest, opts ...grpc.CallOption) (*SendMessageResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/chatinfra.ChatService/SendMessage", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *chatServiceClient) SeenMessage(ctx context.Context, in *SeenMessageRequest, opts ...grpc.CallOption) (*SeenMessageResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/chatinfra.ChatService/SeenMessage", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *chatServiceClient) Subscribe(ctx context.Context, in *SubscribeRequest, opts ...grpc.CallOption) (ChatService_SubscribeClient, error) {
	stream, err := c.cc.NewStream(ctx, &ChatService_ServiceDesc.Streams[0], "/chatinfra.ChatService/Subscribe", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *chatServiceSubscribeClient) Recv() (*Event, error) {
	m := new(Event)
...
func (c *chatServiceClient) Ping(ctx context.Context, in *PingRequest, opts ...grpc.CallOption) (*PingResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/chatinfra.ChatService/Ping", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedChatServiceServer) SeenMessage(context.Context, *SeenMessageRequest) (*SeenMessageResponse, error) {
...
func _ChatService_SendMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/chatinfra.ChatService/SendMessage",
	}
...
func _ChatService_SeenMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/chatinfra.ChatService/SeenMessage",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (x *chatServiceSubscribeServer) Send(m *Event) error {
...
func _ChatService_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/chatinfra.ChatService/Ping",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var ChatService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "chatinfra.ChatService",
